...
int CPcmDecoder::GetMusicChannelsCount()
{
	...
	else if (parent->defoutseted()) return parent->GetDefChannels();
...
int CPcmDecoder::GetMusicBitsPerSample()
{
	...
	else if (parent->defoutseted()) return parent->GetDefBitsPerSample();
...
ULONG CPcmDecoder::GetMusicSampleRate()
{
	...
	else if (parent->defoutseted()) return parent->GetDefSampleRate();
